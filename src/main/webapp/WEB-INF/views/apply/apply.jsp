							...
							<div class="apply_content">
								...
								<div class="ap_mydetail ap_grade">
									...
									<div class="apply_edu_highschool">
										<input type="text" placeholder="학교명" class="ap_inpt apply_shcname"
											id="highName">
										<input type="text" placeholder="입학년월" class="ap_inpt apply_date2"
											id="high_admis">
									...
									<div class="apply_edu_university">
										<input type="text" placeholder="학교명" class="apply_shcname2 ap_inpt"
											id="uniName">
