...
<body>
    ...
    <div id="snb">
        <dl>
            ...
            <dd class="g10"><a href="#">신규공고 등록</a></dd>
            <dt class="g10"><i class="fa-solid fa-gears"></i>관리자설정</dt>
            <dd class="g10 active"><a href="#">관리자 조회<em>195</em></a></dd>
        ...
        <div id="content">
            <div class="s_wrap">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="date" name="to_date" value="" id="to_date" class="frm_input w100"
                                            maxlength="10">
                                        <span class="btn_group"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="오늘"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="어제"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="일주일"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="지난달"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="1개월"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="3개월"><input type="button"
                                                onclick="search_date('fr_date','to_date',this.value);"
                                                class="btn_small white" value="전체"></span>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="local_ov mart30">
                    ...
                    <a href="./member.php?code=register_form" class="fr btn_lsmall green">신규 관리자 생성</a>
                </div>
                <div class="tbl_head01">
                    <table>
                        ...
                        <tbody class="list">
                            ...
                            <tr class="list0">
                                <td><input type="checkbox" name="chk[]" value="3" id="chk_3"></td>
                                <td>3</td>
                                <td><a href="#">adminid001</a></td>
                                <td>김서연</td>
                                <td>Engineering</td>
                            ...
                            <tr class="list0">
                                <td><input type="checkbox" name="chk[]" value="4" id="chk_4"></td>
                                <td>4</td>
                                <td><a href="#">adminid001</a></td>
                                <td>김서연</td>
                                <td>Engineering</td>
