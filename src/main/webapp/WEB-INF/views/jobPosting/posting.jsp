...
<body>
	...
	<form method="post" action="/jobposting">
		...
		<label>직무</label> 
		<select name="jobLevel1" required>
		...
		<label>직무명</label> 
		<select name="jobLevel2" required>
			<c:forEach var="jobItem" items="${jobList}">
				<c:choose>
		...
		<label>노출 종료일</label> 
		<input type="datetime-local" name="postEndDate" required /> <br> 
		...
		<br>
		<label>질문 2</label> <input type="text" name="question2"> <br>
